  ...
  return (
    ...
    >
      ...
      <h1 className="text-2xl md:text-6xl font-bold mb-16 whitespace-nowrap flex justify-center">
        I AM{" "}
        <span className="text-purple-500 typing-effect shadow-sm underline ml-1">
          Mohammad Ghous Mujtaba
        </span>
      </h1>
      ...
      <button className="px-6 py-2 border-2 rounded-full text-purple-500 border-purple-500 hover:bg-purple-500 hover:text-white transition-colors duration-300">
